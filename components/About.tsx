    ...
    >
      ...
      <div className="flex flex-col space-y-10 lg:space-y-0 lg:flex-row lg:space-x-20 items-center justify-center">
        ...
        <div className="flex flex-col max-w-md lg:max-w-2xl text-white text-lg text-justify space-y-5">
          <div>
            <p>
            Full stack developer with 3 years of hands-on experience building real-world products that make a difference. I have got a serious passion for diving into new tech—I never stop learning! On the frontend, I craft responsive and intuitive user interfaces with React, while my backend toolkit includes Node.js, TypeScript, and Golang, with Docker keeping everything nicely containerized. These days, I am getting my hands dirty with AWS cloud services, crafting lambda functions and designing architectures that are both scalable and secure. My approach? Build complete, end-to-end solutions that not only work great today but can grow with tomorrow&apos;s demands. I thrive in collaborative environments where I can both contribute my expertise and absorb new knowledge from those around me.
            </p>
          </div>
